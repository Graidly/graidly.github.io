...
export default function Documentation() {
    const docs = [
        { title: "Project Overview", description: "High-level description of the OpenTa project", link: "/docs/overview" },
        ...
        { title: "User Guide", description: "Step-by-step guide for using the OpenTa system", link: "/docs/user-guide" },
    ]
